...
There are (currently) two GA classes `GeneticAlgorithm::Standard` and `GeneticAlgorithm::Microbial` which perform slightly different styles of evolution (class GA and GeneticAlgorithm are synonymous).
