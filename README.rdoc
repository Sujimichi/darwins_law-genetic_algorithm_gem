...
DarwinsLaw is a Genetic Algorithm gem with the aim of providing simple to use GA's that enable you to focus on the behaviour/characteristics you are trying to evolve.
...
===Options/Args
  ...
  ga = GA::Standard.new(   #or GA::Microbial
    :generations => 500,
    :gene_length => 10,
    :popsize => 30,
    :mutation_rate => 0.1,
